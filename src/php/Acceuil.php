...
<title>PORTFOLIO BTS SIO SLAM- Itic Paris</title>
...
<body>
	...
	<div class="bigDiv">
		...
		<div class="header">
			<img src="../Pictures/ProfilPicture.jpg" alt="photo de profil"
				id="img">
		</div>
...
<!-- 		</div> -->
		...
		<div class="header text-titre">
			<p>
				<b>Candidat:</b> <a href="curriculumVitae.php" target="_blank"> Momo
					Kenfack Koko Jackeve </a>
			</p>
			<p>
				<b>Diplôme:</b> <a href="http://www.bts-sio-formation.com/"
					target="_blank">BTS SIO SLAM</a>
			</p>
			<p>
				<b>Cursus:</b> <a
					href="http://travail-emploi.gouv.fr/formation-professionnelle/formation-en-alternance/article/tout-comprendre-de-l-alternance"
					target="_blank"> Alternance (Contrat de professionalisation) </a>
			</p>
			<p>
				<b>Ecole:</b> <a
					href="http://www.iticparis.com/?gclid=Cj0KEQiAr8W2BRD2qbCOv8_H7qEBEiQA1ErTBs1TJGtdBwI3-FeuvDWDSfZ4BQgm6UhiOgGygyJf-r0aAnbg8P8HAQ"
					target="_blank">Itic Paris <img id="litleLogo" alt="logo Itic"
					src="../Pictures/logoItic.jpg">
				</a>
			</p>
			<p>
				<b>Entreprise:</b> <a href="http://www.solvay.fr/fr/index.html"
					target="_blank">Solvay <img id="litleLogo" alt="logo Solvay"
					src="../Pictures/Solvay.png"></a>
			</p>
		</div>
